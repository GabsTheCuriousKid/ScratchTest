  ...
  $.getJSON("/statistics/data/monthly/", function( data ) {
    ...
    function addMap(distribution) {
        ...
        function getPopulation(country) {
            ...
            if (countryLcase === "c̫te d'ivoire") {
            ...
            if (distribution[country] == undefined ) {
                if (countryLcase == "cura̤ao") return distribution["Curacao"];
                ...
                if (countryLcase == "ṣo tom̩ and principe") return distribution["Sao Tome and Principe"];
